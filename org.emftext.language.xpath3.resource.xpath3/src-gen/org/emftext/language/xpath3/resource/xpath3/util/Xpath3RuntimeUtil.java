 ...
 */
public class Xpath3RuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Plugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Plugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
