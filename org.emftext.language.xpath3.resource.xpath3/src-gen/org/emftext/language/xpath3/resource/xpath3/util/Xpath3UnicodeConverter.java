 ...
 * to 4 bytes).
 */
public class Xpath3UnicodeConverter extends org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3InputStreamProcessor {
	 ...
	 */
	public Xpath3UnicodeConverter(InputStream inputStream) {
