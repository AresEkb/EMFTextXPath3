...
public class Xpath3Nature implements IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.xpath3.resource.xpath3.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3BuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3BuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
