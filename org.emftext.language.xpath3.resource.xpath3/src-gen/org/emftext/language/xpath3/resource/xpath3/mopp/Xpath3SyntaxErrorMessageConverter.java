...
public class Xpath3SyntaxErrorMessageConverter {
	
	private String[] tokenNames;
	
	public Xpath3SyntaxErrorMessageConverter(String[] tokenNames) {
	 ...
	 */
	public org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LocalizedMessage translateLexicalError(RecognitionException e, List<RecognitionException> lexerExceptions, List<Integer> lexerExceptionPositions)  {
		String message = getMessage(e);
		return new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LocalizedMessage(message, e.charPositionInLine, e.line, lexerExceptionPositions.get(lexerExceptions.indexOf(e)), lexerExceptionPositions.get(lexerExceptions.indexOf(e)));
	}
	
	/**
	 * Translates errors thrown by the parser into human readable messages.
	 */
	public org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LocalizedMessage translateParseError(RecognitionException e)  {
		String message = getMessage(e);
		
		if (e.token instanceof CommonToken) {
			CommonToken ct = (CommonToken) e.token;
			return new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LocalizedMessage(message, ct.getCharPositionInLine(), ct.getLine(), ct.getStartIndex(), ct.getStopIndex());
		} else {
			int position = 1;
			int line = 1;
			if (e.token != null) {
			...
			return new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LocalizedMessage(message, position, line, 1, 5);
		}
	}
	...
	protected String getTokenName(int tokenType)  {
		...
		if (tokenType < 0) {
			...
			tokenName = org.emftext.language.xpath3.resource.xpath3.util.Xpath3StringUtil.formatTokenName(tokenName);
		}
		return tokenName;
	}
