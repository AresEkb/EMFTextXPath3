	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = org.emftext.language.xpath3.resource.xpath3.util.Xpath3ListUtil.copySafelyToObjectList(currentValueAsList);
