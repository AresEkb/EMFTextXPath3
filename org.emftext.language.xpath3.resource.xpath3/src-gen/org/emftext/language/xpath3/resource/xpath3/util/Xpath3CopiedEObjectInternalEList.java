...
public class Xpath3CopiedEObjectInternalEList extends org.emftext.language.xpath3.resource.xpath3.util.Xpath3CopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public Xpath3CopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
