 ...
 */
public interface IXpath3Options {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation().getResourcePostProcessorProviderOptionKey();
