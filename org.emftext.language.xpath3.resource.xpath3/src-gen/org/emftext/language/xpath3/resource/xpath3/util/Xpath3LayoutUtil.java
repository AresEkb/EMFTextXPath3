...
public class Xpath3LayoutUtil {
	...
	public void transferLayoutInformationToModel(EObject element) {
		...
		for (Iterator<org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(EObject element) {
		...
		if (layoutReference != null) {
			...
			for (Iterator<EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public EObject createLayoutInformationModelElement(org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation layoutInformation, EPackage layoutPackage) {
		EFactory factory = layoutPackage.getEFactoryInstance();
		Object object = layoutInformation.getObject(null, false);
		org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3SyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3GrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation createLayoutInformation(EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3SyntaxElement syntaxElement = org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3GrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3Placeholder) {
			org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3Placeholder placeholder = (org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3Placeholder) syntaxElement;
			org.emftext.language.xpath3.resource.xpath3.IXpath3TokenResolver tokenResolver = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3TokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.emftext.language.xpath3.resource.xpath3.IXpath3TokenResolveResult result = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3TokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformationAdapter getLayoutInformationAdapter(EObject element) {
	...
	public void removeLayoutInformationAdapter(EObject element) {
		org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3LayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);
