 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.ValueCompImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ValueCompImpl extends CompImpl implements ValueComp {
    /**
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.VALUE_COMP;
    }
    ...
    public void setOperator(GeneralCompKind newOperator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.VALUE_COMP__OPERATOR, oldOperator, operator));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.VALUE_COMP__OPERATOR:
                return getOperator();
        }
