 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerLiteralImpl extends NumericLiteralImpl implements IntegerLiteral {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.INTEGER_LITERAL;
    }
    ...
    public void setValue(int newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.INTEGER_LITERAL__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.INTEGER_LITERAL__VALUE:
                return getValue();
        }
