 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.GeneralCompImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralCompImpl extends CompImpl implements GeneralComp {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.GENERAL_COMP;
    }
    ...
    public void setOperator(GeneralCompKind newOperator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.GENERAL_COMP__OPERATOR, oldOperator, operator));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.GENERAL_COMP__OPERATOR:
                return getOperator();
        }
