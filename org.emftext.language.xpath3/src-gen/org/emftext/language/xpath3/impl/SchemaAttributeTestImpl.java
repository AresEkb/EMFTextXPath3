 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.SchemaAttributeTestImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaAttributeTestImpl extends KindTestImpl implements SchemaAttributeTest {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.SCHEMA_ATTRIBUTE_TEST;
    }
    ...
    public void setName(QName newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.SCHEMA_ATTRIBUTE_TEST__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.SCHEMA_ATTRIBUTE_TEST__NAME:
                return getName();
        }
