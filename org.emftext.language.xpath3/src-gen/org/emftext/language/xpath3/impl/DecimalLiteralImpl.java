 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.DecimalLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalLiteralImpl extends NumericLiteralImpl implements DecimalLiteral {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.DECIMAL_LITERAL;
    }
    ...
    public void setValue(float newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.DECIMAL_LITERAL__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.DECIMAL_LITERAL__VALUE:
                return getValue();
        }
