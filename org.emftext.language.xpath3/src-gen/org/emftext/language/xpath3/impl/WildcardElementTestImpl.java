 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.WildcardElementTestImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WildcardElementTestImpl extends ElementTestImpl implements WildcardElementTest {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.WILDCARD_ELEMENT_TEST;
    }
    ...
    public NotificationChain basicSetType(OptionalAtomicType newType, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPath3Package.WILDCARD_ELEMENT_TEST__TYPE, oldType, newType);
    ...
    public void setType(OptionalAtomicType newType) {
        if (newType != type) {
            ...
            if (type != null)
                msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPath3Package.WILDCARD_ELEMENT_TEST__TYPE, null, msgs);
            if (newType != null)
                msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPath3Package.WILDCARD_ELEMENT_TEST__TYPE, null, msgs);
            msgs = basicSetType(newType, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.WILDCARD_ELEMENT_TEST__TYPE, newType, newType));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case XPath3Package.WILDCARD_ELEMENT_TEST__TYPE:
