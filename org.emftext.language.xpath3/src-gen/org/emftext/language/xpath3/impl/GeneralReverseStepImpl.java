...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>General Reverse Step</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.GeneralReverseStepImpl#getAxis <em>Axis</em>}</li>
 *   <li>{@link org.emftext.language.xpath3.impl.GeneralReverseStepImpl#getNodeTest <em>Node Test</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralReverseStepImpl extends ReverseStepImpl implements GeneralReverseStep {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.GENERAL_REVERSE_STEP;
    }
    ...
    public void setAxis(ReverseAxisKind newAxis) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.GENERAL_REVERSE_STEP__AXIS, oldAxis, axis));
    }
    ...
    public NotificationChain basicSetNodeTest(NodeTest newNodeTest, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST, oldNodeTest, newNodeTest);
    ...
    public void setNodeTest(NodeTest newNodeTest) {
        if (newNodeTest != nodeTest) {
            ...
            if (nodeTest != null)
                msgs = ((InternalEObject)nodeTest).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST, null, msgs);
            if (newNodeTest != null)
                msgs = ((InternalEObject)newNodeTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST, null, msgs);
            msgs = basicSetNodeTest(newNodeTest, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST, newNodeTest, newNodeTest));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.GENERAL_REVERSE_STEP__AXIS:
                return getAxis();
            case XPath3Package.GENERAL_REVERSE_STEP__NODE_TEST:
                return getNodeTest();
        }
