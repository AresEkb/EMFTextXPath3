 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.NodeCompImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeCompImpl extends CompImpl implements NodeComp {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.NODE_COMP;
    }
    ...
    public void setOperator(NodeCompKind newOperator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.NODE_COMP__OPERATOR, oldOperator, operator));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.NODE_COMP__OPERATOR:
                return getOperator();
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case XPath3Package.NODE_COMP__OPERATOR:
                setOperator((NodeCompKind)newValue);
                return;
        }
