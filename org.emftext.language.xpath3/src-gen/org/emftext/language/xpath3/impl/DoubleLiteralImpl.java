 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleLiteralImpl extends NumericLiteralImpl implements DoubleLiteral {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.DOUBLE_LITERAL;
    }
    ...
    public void setValue(double newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.DOUBLE_LITERAL__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.DOUBLE_LITERAL__VALUE:
                return getValue();
        }
