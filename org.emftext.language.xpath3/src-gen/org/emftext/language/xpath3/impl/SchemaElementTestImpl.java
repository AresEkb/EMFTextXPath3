 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath3.impl.SchemaElementTestImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaElementTestImpl extends KindTestImpl implements SchemaElementTest {
    ...
    protected EClass eStaticClass() {
        return XPath3Package.Literals.SCHEMA_ELEMENT_TEST;
    }
    ...
    public void setName(QName newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, XPath3Package.SCHEMA_ELEMENT_TEST__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case XPath3Package.SCHEMA_ELEMENT_TEST__NAME:
                return getName();
        }
