 ...
 */
public class Xpath3Highlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor;
	private ProjectionViewer projectionViewer;
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Occurrence occurrence;
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.emftext.language.xpath3.resource.xpath3.IXpath3BackgroundParsingListener {
	 ...
	 */
	public Xpath3Highlighting(org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource textResource, ProjectionViewer projectionViewer, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3ColorManager colorManager, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Occurrence(textResource, projectionViewer);
		this.bracketSet = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3EObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
