 ...
 */
public class Xpath3UIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.xpath3.resource.xpath3.ui";
	public static final String EDITOR_ID = "org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor";
	...
	private static Xpath3UIPlugin plugin;
	
	public Xpath3UIPlugin() {
		super();
	}
	...
	public static Xpath3UIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, Xpath3UIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, Xpath3UIPlugin.PLUGIN_ID, message);
		}
		final Xpath3UIPlugin pluginInstance = Xpath3UIPlugin.getDefault();
