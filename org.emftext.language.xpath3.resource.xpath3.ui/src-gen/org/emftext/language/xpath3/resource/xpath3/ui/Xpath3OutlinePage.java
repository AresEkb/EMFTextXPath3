 ...
 */
public class Xpath3OutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.language.xpath3.resource.xpath3.ui.outlinecontext";
	...
	public Xpath3OutlinePage(org.emftext.language.xpath3.resource.xpath3.IXpath3ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageTreeViewer) {
								org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageTreeViewer pageTreeViewer = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.xpath3.resource.xpath3.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3OutlinePageActionProvider().getActions(treeViewer);
