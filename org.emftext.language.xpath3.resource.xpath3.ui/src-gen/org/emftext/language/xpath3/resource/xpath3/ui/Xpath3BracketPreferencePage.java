 ...
 * </p>
 */
public class Xpath3BracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation().getSyntaxName();
	
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public Xpath3BracketPreferencePage() {
		super();
		
		org.emftext.language.xpath3.resource.xpath3.IXpath3MetaInformation metaInformation = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation();
	...
	public void init(IWorkbench workbench) {
		setPreferenceStore(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		String defaultBrackets = preferenceStore.getDefaultString(language + org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		IWorkbench workbench = org.eclipse.ui.PlatformUI.getWorkbench();
		IEditorPart editor = workbench.getActiveWorkbenchWindow().getActivePage().getActiveEditor();
		if (editor != null && editor instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) {
			((org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) editor).invalidateTextRepresentation();
		}
	}
	
	protected org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair getSelectedBracketPair() {
