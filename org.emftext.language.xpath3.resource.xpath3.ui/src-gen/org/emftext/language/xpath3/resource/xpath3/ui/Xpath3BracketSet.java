...
public class Xpath3BracketSet {
	...
	private ArrayList<org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public Xpath3BracketSet() {
		super();
		this.languageID = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair>();
	}
	...
	public org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3BracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair remove(String opening, String closing) {
		for (org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.emftext.language.xpath3.resource.xpath3.IXpath3BracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
