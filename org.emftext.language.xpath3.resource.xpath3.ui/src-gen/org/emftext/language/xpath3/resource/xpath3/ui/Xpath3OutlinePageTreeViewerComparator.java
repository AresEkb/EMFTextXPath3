...
public class Xpath3OutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.emftext.language.xpath3.resource.xpath3.IXpath3NameProvider nameProvider = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation().createNameProvider();
