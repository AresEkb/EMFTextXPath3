 ...
 */
public class Xpath3ContentAssistPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Xpath3ContentAssistPreferencePage() {
		initialize();
	}
	...
	public void init(IWorkbench workbench) {
		...
		// init values
		assistEnabled = preferenceStore.getBoolean(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getInt(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getString(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
	}
	...
	protected void performDefaults() {
		...
		activationDelay = preferenceStore.getDefaultInt(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getDefaultString(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
		// defaults in widgets
	...
	private boolean updatePreferences() {
		...
		try {
			...
			org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Plugin.getDefault().getLog().log(			new Status(IStatus.ERROR			, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.getDefault().getBundle().getSymbolicName()			, "Value '" + delayText + "' is no valid delay value"			, exception)			);
			return false;
		}
		activationTriggers = txtTriggers.getText();
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED, assistEnabled);
		preferenceStore.setValue(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY, activationDelay);
		preferenceStore.setValue(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS, activationTriggers);
		return true;
	}
