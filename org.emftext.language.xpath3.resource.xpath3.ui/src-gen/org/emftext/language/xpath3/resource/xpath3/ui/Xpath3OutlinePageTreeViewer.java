 ...
 * a specified depth.
 */
public class Xpath3OutlinePageTreeViewer extends TreeViewer {
	...
	public Xpath3OutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Plugin.logError("Exception while refreshing outline view", e);
		}
	}
