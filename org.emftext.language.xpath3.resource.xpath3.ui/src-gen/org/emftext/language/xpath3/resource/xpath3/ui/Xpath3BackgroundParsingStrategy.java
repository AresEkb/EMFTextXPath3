 ...
 */
public class Xpath3BackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource resource, final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource resource, final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource resource, final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource) {
							org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource concreteResource = (org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource) resource;
