 ...
 * @since 3.2
 */
public class Xpath3BrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput fInput;
	 ...
	 */
	public Xpath3BrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Xpath3BrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Xpath3BrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput) input;
		...
		org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput getInput() {
		return fInput;
	}
