 ...
 */
public class Xpath3IgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.xpath3.resource.xpath3.grammar.Xpath3GrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
