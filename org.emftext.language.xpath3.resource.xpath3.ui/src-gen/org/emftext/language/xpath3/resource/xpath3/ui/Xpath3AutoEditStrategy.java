...
/**
 * The Xpath3AutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class Xpath3AutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet bracketSet;
	
	public Xpath3AutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BracketSet bracketSet) {
