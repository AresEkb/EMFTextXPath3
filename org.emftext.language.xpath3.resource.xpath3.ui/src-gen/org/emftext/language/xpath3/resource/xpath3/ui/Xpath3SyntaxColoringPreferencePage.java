 ...
 * </p>
 */
public class Xpath3SyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Xpath3SyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation metaInformation = new org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3MetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3SyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PixelConverter pixelConverter = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) {
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor emfTextEditor = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) editor;
