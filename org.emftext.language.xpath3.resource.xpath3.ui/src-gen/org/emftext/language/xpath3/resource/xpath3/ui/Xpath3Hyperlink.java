 ...
 */
public class Xpath3Hyperlink implements IHyperlink {
	 ...
	 */
	public Xpath3Hyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
