 ...
 */
public class Xpath3CodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.xpath3.resource.xpath3.IXpath3BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) {
				org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor) workbenchPart;
	...
	protected org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor;
	 ...
	 */
	public Xpath3CodeFoldingManager(ProjectionViewer sourceViewer,org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Editor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource textResource = (org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource) editor.getResource();
		IDocument document = sourceViewer.getDocument();
