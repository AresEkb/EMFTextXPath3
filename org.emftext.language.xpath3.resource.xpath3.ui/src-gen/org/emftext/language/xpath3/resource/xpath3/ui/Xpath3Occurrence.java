 ...
 */
public class Xpath3Occurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.xpath3.resource.xpath3.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.xpath3.resource.xpath3.ui.occurences.declaration";
	
	private final static org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionHelper positionHelper = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionHelper();
	...
	/**
	 * <p>
	 * Creates a Xpath3Occurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public Xpath3Occurrence(org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(org.emftext.language.xpath3.resource.xpath3.IXpath3LocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new org.emftext.language.xpath3.resource.xpath3.analysis.Xpath3DefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		org.emftext.language.xpath3.resource.xpath3.IXpath3LocationMap locationMap = textResource.getLocationMap();
		
		org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner tokenScanner = createTokenScanner();
	...
	protected org.emftext.language.xpath3.resource.xpath3.ui.IXpath3TokenScanner createTokenScanner() {
		return new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory type, String text, int offset, int length) {
		...
		if (type == org.emftext.language.xpath3.resource.xpath3.ui.Xpath3PositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Occurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Occurrence.DECLARATION_ANNOTATION_ID);
	}
