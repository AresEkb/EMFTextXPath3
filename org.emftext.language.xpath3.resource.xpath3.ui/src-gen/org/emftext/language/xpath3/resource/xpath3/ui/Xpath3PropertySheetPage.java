...
public class Xpath3PropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3EObjectSelection) {
			final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3EObjectSelection selection = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3EObjectSelection) iSelection;
