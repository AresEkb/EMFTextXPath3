 ...
 */
public class Xpath3TextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private org.emftext.language.xpath3.resource.xpath3.IXpath3HoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput infoInput = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Hyperlink hyperlink = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl iControl = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput) {
							org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput input = (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl iControl = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public Xpath3TextHover(org.emftext.language.xpath3.resource.xpath3.IXpath3ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.xpath3.resource.xpath3.ui.Xpath3TextHover.getStyleSheet());
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.xpath3.resource.xpath3.ui.Xpath3DocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.language.xpath3.resource.xpath3.ui.Xpath3HTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.language.xpath3.resource.xpath3.util.Xpath3StreamUtil.getContent(styleSheetURL.openStream());
