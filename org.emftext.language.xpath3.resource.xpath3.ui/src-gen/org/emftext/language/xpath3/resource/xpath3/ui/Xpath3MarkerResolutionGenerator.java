...
public class Xpath3MarkerResolutionGenerator implements IMarkerResolutionGenerator {
	...
	public IMarkerResolution[] getResolutions(IMarker marker) {
		try {
			...
			if (resource instanceof IFile) {
				...
				rs.getLoadOptions().put(org.emftext.language.xpath3.resource.xpath3.IXpath3Options.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource) {
					org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource customResource = (org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3Resource) emfResource;
					EcoreUtil.resolveAll(customResource);
					Collection<org.emftext.language.xpath3.resource.xpath3.IXpath3QuickFix> quickFixes = getQuickFixes(customResource, marker);
					List<IMarkerResolution2> resolutions = new ArrayList<IMarkerResolution2>();
					for (final org.emftext.language.xpath3.resource.xpath3.IXpath3QuickFix quickFix : quickFixes) {
						resolutions.add(new IMarkerResolution2() {
							...
							public void run(IMarker marker) {
								...
								try {
									...
									org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.language.xpath3.resource.xpath3.ui.Xpath3UIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new IMarkerResolution[] {};
	}
	
	public Collection<org.emftext.language.xpath3.resource.xpath3.IXpath3QuickFix> getQuickFixes(org.emftext.language.xpath3.resource.xpath3.IXpath3TextResource resource, IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.language.xpath3.resource.xpath3.IXpath3QuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
