 ...
 */
public class Xpath3CompletionProposal implements Comparable<Xpath3CompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3ExpectedTerminal expectedTerminal;
	...
	public Xpath3CompletionProposal(org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public Xpath3CompletionProposal(org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public Xpath3CompletionProposal(org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.language.xpath3.resource.xpath3.mopp.Xpath3ExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof Xpath3CompletionProposal) {
			Xpath3CompletionProposal other = (Xpath3CompletionProposal) object;
	...
	public int compareTo(Xpath3CompletionProposal object) {
		if (object instanceof Xpath3CompletionProposal) {
			Xpath3CompletionProposal other = (Xpath3CompletionProposal) object;
